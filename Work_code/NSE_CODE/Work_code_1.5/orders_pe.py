...
csv_file_path = 'options_tradingsymbols_pe.csv'  
options_csv_df = pd.read_csv(csv_file_path)
symbol = options_csv_df.tradingsymbol.iloc[0]  # Example: NIFTY
quantity = 15

#Files
signal_file='signal_pe.json'
order_file='order_pe.json'  
price_file = "avg_price_pe.json"
...
def place_new_order(symbol, order_type, quantity=quantity, order_file='order_pe.json'):
    new_order = {
        "symbol": symbol,
